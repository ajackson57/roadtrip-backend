...
RSpec.describe MarkersController, type: :controller do
  ...
  # MarkersController. Be sure to keep this updated too.
  let(:valid_session) { {} }
  ...
  describe "GET #show" do
    it "assigns the requested marker as @marker" do
      marker = Marker.create! valid_attributes
      get :show, params: {id: marker.to_param}, session: valid_session
  ...
  describe "GET #new" do
    it "assigns a new marker as @marker" do
      ...
      expect(assigns(:marker)).to be_a_new(Marker)
    end
  end
  ...
  describe "GET #edit" do
    it "assigns the requested marker as @marker" do
      marker = Marker.create! valid_attributes
      get :edit, params: {id: marker.to_param}, session: valid_session
      expect(assigns(:marker)).to eq(marker)
    end
  end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested marker" do
        marker = Marker.create! valid_attributes
        put :update, params: {id: marker.to_param, marker: new_attributes}, session: valid_session
        marker.reload
      ...
      it "assigns the requested marker as @marker" do
        marker = Marker.create! valid_attributes
        put :update, params: {id: marker.to_param, marker: valid_attributes}, session: valid_session
        expect(assigns(:marker)).to eq(marker)
      end
      ...
      it "redirects to the marker" do
        marker = Marker.create! valid_attributes
        put :update, params: {id: marker.to_param, marker: valid_attributes}, session: valid_session
        expect(response).to redirect_to(marker)
      end
    end
    ...
    context "with invalid params" do
      it "assigns the marker as @marker" do
        marker = Marker.create! valid_attributes
        put :update, params: {id: marker.to_param, marker: invalid_attributes}, session: valid_session
        expect(assigns(:marker)).to eq(marker)
      end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested marker" do
      marker = Marker.create! valid_attributes
      expect {
        delete :destroy, params: {id: marker.to_param}, session: valid_session
      }.to change(Marker, :count).by(-1)
    end
